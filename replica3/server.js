...
const NODE_ID = process.env.NODE_ID || 'replica3';
const PORT    = parseInt(process.env.PORT) || 3003;
const GATEWAY_URL = process.env.GATEWAY_URL || 'http://localhost:8080';

// local host, not with docker
// const PEERS = [
//   { id: 'replica1', host: 'localhost', port: 3001 },
...
const defaultPeers = [
  { id: 'replica1', host: IS_DOCKER ? 'replica1' : 'localhost', port: 3001 },
